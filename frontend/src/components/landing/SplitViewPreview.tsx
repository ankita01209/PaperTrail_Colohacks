        ...
        <div className="w-full lg:w-1/2">
          ...
          <div className="flex flex-col gap-6">
            {features.map((feature, i) => (
              ...
              >
                <div className="mt-1 10 w-10 h-10 shrink-0 rounded-full bg-[var(--color-surface-highest)] border border-[var(--color-ghost-border)] flex items-center justify-center text-[var(--color-primary)]">
